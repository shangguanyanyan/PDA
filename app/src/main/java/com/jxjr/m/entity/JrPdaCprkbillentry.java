...
public class JrPdaCprkbillentry implements java.io.Serializable,Cloneable {
	...
	public JrPdaCprkbillentry() {
	}

	public JrPdaCprkbillentry(int id) {
		this.id = id;
	}

	
	public JrPdaCprkbillentry(int id, int parentid, String fid,
	...
	@Override  
    public Object clone() {  
		JrPdaCprkbillentry obj = null;  
        try{  
        	obj = (JrPdaCprkbillentry)super.clone();  
