...
public class JrPdaScllbillentry implements java.io.Serializable,Cloneable {
	...
	public JrPdaScllbillentry() {
	}

	public JrPdaScllbillentry(int id) {
		this.id = id;
	}
	...
	public JrPdaScllbillentry(int id, int parentid, String fid,
	...
	@Override  
    public Object clone() {  
		JrPdaScllbillentry obj = null;  
        try{  
        	obj = (JrPdaScllbillentry)super.clone();  
