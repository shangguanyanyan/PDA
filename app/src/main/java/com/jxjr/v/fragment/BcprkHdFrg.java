...
import com.jxjr.contract.BcprkContract.IfBcprkHdFrgView;
...
public class BcprkHdFrg extends ABaseFTBillHdFrg<JrPdaBcprkbill,BcprkActivity>{

	BcprkActivity mActivity;	

	JrPdaBcprkbill billhd;
...
//	JrPurInWarehsBill billhd=new JrPurInWarehsBill();	
	...
	protected int setLayoutID() {
		// TODO Auto-generated method stub
		return R.layout.activity_bcprk_hd;
	}
...
//		checker=new DataChecker();
		...
		mActivity=(BcprkActivity) getActivity();
		initData();
		initWidget();
		checker=new DataChecker();
		alertDialog=iGetActivity().getAlertDialog();
		BcprkActivity mActivity=(BcprkActivity) iGetActivity();
		JrBcprkBillDTO entity= mActivity.getEntity();
