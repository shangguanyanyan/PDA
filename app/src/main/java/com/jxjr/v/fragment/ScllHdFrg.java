...
public class ScllHdFrg extends ABaseFTBillHdFrg<JrPdaScllbill,ScllActivity> implements IfScllHdFrgView{

	ScllActivity mActivity;	

	JrPdaScllbill billhd;
...
//	JrPurInWarehsBill billhd=new JrPurInWarehsBill();	
	...
	protected int setLayoutID() {
		// TODO Auto-generated method stub
		return R.layout.activity_scll_hd;
	}
...
//		checker=new DataChecker();
		...
		mActivity=(ScllActivity) getActivity();
		initData();
		initWidget();
		checker=new DataChecker();
		alertDialog=iGetActivity().getAlertDialog();
		ScllActivity mActivity=(ScllActivity) iGetActivity();
		JrScllBillDTO entity= mActivity.getEntity();
